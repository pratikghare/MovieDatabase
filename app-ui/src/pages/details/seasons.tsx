...

                {
                    details && active ?
                        <div className={'font-bold flex flex-col'}>
                            ...
                            <h1 className='text-xs md:text-sm'>{active.name} ({active.episodes.length} episodes)</h1>
                        </div> :
...
function EpisodeCard({ episode, title }: { episode?: CompactEpisode, title: string }) {
    ...
    return episode && (
        <Card className='shadow-none border-1 border-foreground/10 rounded-md'>
            <div className='flex flex-wrap sm:flex-nowrap gap-4 items-start p-2'>
                ...
                <div className='flex flex-col gap-2 justify-start items-start'>
                    ...
                    <CardBody className='text-small text-default-400 backdrop p-0'>
                        {
                            episode ?
                                <ScrollShadow hideScrollBar className={'max-h-[80px] text-xs '}>
